...
<nav class="nav-extended wavaes light-blue ">
    <div class="nav-wrapper container">
      ...
      <li class="<?php echo ($page == "index"||"prescribe" ? "active" : "")?>"><a href="<?=base_url('index.php/Doctor/view/prescribe')?>">Prescribe</a></li>
      <li class="<?php echo ($page == "profile" ? "active" : "")?>"><a href="<?=base_url('index.php/Doctor/view/profile')?>">Profile</a></li>
