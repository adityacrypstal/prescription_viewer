              ...
              if(obj.length>0){
                   try{
                    ...
                    $.each(obj, function(i,val){           
                      trHTML += '<tr><td>' + val.fname + '</td><td>' + val.lname + '</td><td>' + val.age+'</td><td>' + val.blood  + '</td><td>' + val.Id +'</td><td>' + val.contact+'</td></tr>';
                       });
                       trHTML2 += '<tr><th>' + 'First Name' + '</th><th>' + 'Second Name' + '</th><th>' + 'Age'+'</th><th>' +'Blood'  + '</th><th>' + 'Id' +'</th><th>' + 'Contact'+'</th></th>';
